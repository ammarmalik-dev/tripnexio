...
interface OtbSuccessPanelProps {
  referenceId: string;
}

export function OtbSuccessPanel({ referenceId }: OtbSuccessPanelProps) {
  return (
    <div className="flex flex-col items-center gap-4 rounded-xl border border-hairline bg-surface-1 px-6 py-14 text-center">
      ...
      <div className="flex flex-col gap-1">
        <p className="text-lg font-semibold text-ink-heading">Request submitted</p>
        <p className="max-w-sm text-sm text-ink-secondary">
          Your OTB request has been received. Our team will verify the details
